...
class UIElement :
    ...
    def __init__(self, rect, element_type, label="", min_val=0,
                  max_val=1, value=0):
    ...
    def draw(self, screen):
        font = pygame.font.SysFont(None, 
                                   24 if self.type == 'slider' else 28)
        if self.type == 'slider':
            ...
            screen.blit(txt, 
                        (self.rect.x + self.rect.width + 20, self.rect.y))
        ...
        if self.type == 'button':
            ...
            if ((event.type == pygame.MOUSEBUTTONDOWN or 
                ...
                if self.rect.collidepoint(event.pos):
                    ...
                    self.value = int(self.min_val + ratio * 
                                     (self.max_val - self.min_val))
