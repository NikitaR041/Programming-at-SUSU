object Form1: TForm1
  ...
  object MainMenu1: TMainMenu
    ...
    object N1: TMenuItem
      ...
      object ClientSocketandServerSocket1: TMenuItem
        Caption = 'ClientSocket and ServerSocket'
        OnClick = ClientSocketandServerSocket1Click
      end
      object WebBrouser1: TMenuItem
        Caption = 'WebBrouser'
        OnClick = WebBrouser1Click
      end
    end
  end
end
